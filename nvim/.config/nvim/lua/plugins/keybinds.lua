...
local keybinds = {
	...
	{ "<leader>yw", "<cmd>Gitsigns preview_hunk_inline<CR>", desc = "Preview Hunk" },
	{ "<leader>ys", ":Gitsigns stage_hunk<CR>", desc = "Toggle Stage Hunk", mode = { "n", "v" } },
	{ "<leader>yS", "<cmd>Gitsigns stage_buffer<CR>", desc = "Stage Buffer" },
	{ "<leader>yU", "<cmd>Gitsigns reset_buffer_index<CR>", desc = "Unstage Buffer" },
	{ "<leader>yy", "<cmd>Gitsigns next_hunk<CR>", desc = "Next Hunk" },
	{ "<leader>yY", "<cmd>Gitsigns prev_hunk<CR>", desc = "Next Hunk" },
	{ "<leader>yr", "<cmd>Gitsigns reset_hunk<CR>" },
